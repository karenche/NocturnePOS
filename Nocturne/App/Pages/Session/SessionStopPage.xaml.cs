...
{
    public sealed partial class SessionStopPage : Page
    {
        public SessionStopViewModel CurrentViewModel { get; private set; }

        public SessionStopPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            var viewModel = new SessionStopViewModel(sessionService, cardService, customerService, productService, navigationService);
